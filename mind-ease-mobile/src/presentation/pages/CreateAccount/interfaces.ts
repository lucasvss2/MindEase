...
export interface ICreateAccountFields
  extends ICreateAccountFieldsStep1, ICreateAccountFieldsStep2 {}

export interface IPersonalInfosStep extends ICreateAccountSharedProps<{
...
export interface IDefinePasswordStep extends ICreateAccountSharedProps<{
